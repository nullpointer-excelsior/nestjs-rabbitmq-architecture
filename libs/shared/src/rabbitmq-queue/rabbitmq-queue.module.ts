...
import { RabbitmqProducerClient } from './services/rabbitmq-producer-client.service';
import { RABBITMQ_PRODUCER_CLIENT } from './config/providers.tokens';
import { createDeadLetter } from './services/create-dead-letter';
import { RabbitmqQueueConfigFactory } from './config/rabbitmq-queue.config';
